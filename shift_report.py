...
def analyze_tasks(groups):
    ...
    system = (
        ...
        "Charlotte did not; 'nobody' if no one addressed it. Known customer service "
        "teammates include Layla, Mason, and Dustin — a reply from them (or any "
        "other staff member) means the task is handled ('other'), NOT unanswered. "
